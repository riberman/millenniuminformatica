...
<?php if (!empty($_POST['txtNome']) && !empty($_POST['txtEmail']) && !empty($_POST['txtMensagem'])): 
			...
			$nome = $_POST['txtNome'];	
			$mensagem = "Obrigado pelo seu contato $_POST[txtNome], responderemos em breve. <br/>
			             Contato: <br/>
			             (42) 3035-4713  (42) 99957-9938 <br/>
			             comercial@millenniumservicos.com.br <br/>
			             millenniumservicos.com.br";
			$assunto = "Obrigado pelo seu contato!";
			include("../../root/envio.php");
			
			//envia o e-mail para o administrador do site
			$mailDestino = 'comercial@millenniumservicos.com.br'; 
			$nome = 'Comercial Millennium Serviços';	
